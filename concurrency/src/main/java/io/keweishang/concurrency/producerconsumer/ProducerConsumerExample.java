package io.keweishang.concurrency.producerconsumer;
...
public class ProducerConsumerExample {
    public static void main(String[] args)
        ...
        // need to manually stop the program, as this program is for demo only
    }
        ...
        public void consume() throws InterruptedException {
            while (true) {
                synchronized (this) {
                    ...
                    System.out.println("Notifying all producers...");
                    // and sleep
                    Thread.sleep(1000);
                }
            }
