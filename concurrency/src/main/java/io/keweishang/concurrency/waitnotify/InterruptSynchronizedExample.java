...
// Interrupt the thread when it is trying to obtain the intrinsic lock by using synchronized()
// Result: thread cannot be interrupted while calling synchronized()
public class InterruptSynchronizedExample {
    ...
    public static void main(String[] args) {
        ...
        // Conclusion: we cannot interrupt() the thread when the thread is trying to obtain the intrinsic lock with
