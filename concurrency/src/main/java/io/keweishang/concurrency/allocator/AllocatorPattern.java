package io.keweishang.concurrency.allocator;

import java.util.ArrayList;
import java.util.List;
import java.util.concurrent.CountDownLatch;

// Use Allocator to allocate all resources or nothing.
// This pattern prevents dead-lock because it does not partially lock resources, but lock all resources.
// An example of sending money between two accounts.
public class AllocatorPattern {
